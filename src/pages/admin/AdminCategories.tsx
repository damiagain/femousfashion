...
export function AdminCategories() {
  ...
  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const slug = name
      ...
      .replace(/[^a-z0-9]+/g, "-")
      .replace(/(^-|-$)+/g, "");
    setFormData({ ...formData, name, slug: slug as any });
  };
    ...
    <div className="flex flex-col gap-8">
      ...
      {isModalOpen && (
        <>
          ...
          {/* Modal Box */}
          <div className="fixed left-1/2 top-1/2 z-50 w-[92%] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-6 shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="flex flex-col gap-4">
              ...
              <div>
                ...
                <div
                  ...
                  className="flex h-28 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 hover:border-[#D4A373] transition-colors"
                >
                  {imagePreview ? (
                    <img
                      src={imagePreview}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 p-3 font-inter text-sm outline-none focus:border-[#D4A373]"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="rounded-lg px-5 py-2.5 font-inter text-sm font-semibold text-gray-500 hover:bg-gray-100"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="rounded-lg bg-[#2B3A55] px-7 py-2.5 font-inter text-sm font-semibold text-white active:scale-95 transition-transform"
                >
                  Save
                </button>
              </div>
